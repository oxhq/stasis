 ...
 * v0.1.0-alpha.0 bytes, not a v0.3.0 distribution manifest. The gated release
 * workflow must replace this module with the exact generated v0.3.0 manifest
...
} as const satisfies RuntimeDistributionManifest;
