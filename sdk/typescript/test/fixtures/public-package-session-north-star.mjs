...
async function inspectManagedRuntimeCacheProof(proof) {
  ...
  assert.equal(marker.sdkVersion, "0.2.0");
  assert.equal(marker.releaseTag, "v0.2.0");
  ...
  assert.equal(
    archiveUrl.href,
    `https://github.com/oxhq/stasis/releases/download/v0.2.0/stasis-0.2.0-${expectedReleasePlatform}.tar.gz`,
  );
...
function assertV02Capabilities(runtime) {
  ...
  assert.equal(runtime.info.implementation.version, "0.2.0");
