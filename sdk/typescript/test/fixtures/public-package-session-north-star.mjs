...
async function inspectManagedRuntimeCacheProof(proof) {
  ...
  assert.equal(marker.sdkVersion, "0.3.3");
  assert.equal(marker.releaseTag, "v0.3.3");
  ...
  assert.equal(
    archiveUrl.href,
    `https://github.com/oxhq/stasis/releases/download/v0.3.3/stasis-0.3.3-${expectedReleasePlatform}.tar.gz`,
  );
...
function assertV02Capabilities(runtime) {
  ...
  assert.equal(runtime.info.implementation.version, "0.3.3");
